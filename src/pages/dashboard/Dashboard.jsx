  ...
  return (
    <div className='flex w-screen'>
      ...
      <div className='flex flex-col ml-20% w-4/5'>
        <PageName page={path}/>
        <div className=' bg-gradient-to-br rounded-lg flex from-mainColorTwo px-11 w-11/12 h-52  overflow-y-hidden to-mainColorOne ml-16 mt-8 h-auto '>
          ...
          <div className='flex-1 '>
            <img src={Dash} alt="" width={300} style={{marginLeft: '195px'}}/>
          </div>
        </div>
      </div>
    </div>
